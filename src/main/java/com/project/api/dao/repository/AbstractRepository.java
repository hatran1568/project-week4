...
public class AbstractRepository {
    ...
    protected void updateIsDeleted(Object object, int id, int isDeleted){
        StringBuilder sql = new StringBuilder();
        sql.append("UPDATE ").append(getSimpleNameTable(object.getClass()));
        sql.append(" SET is_deleted = ? WHERE id = ?");
        jdbcTemplate.update(sql.toString(), isDeleted, id);
    }
}
